...
assert(JSON.stringify(manifest.permissions) === JSON.stringify(["activeTab", "contextMenus", "storage"]), "permissions must stay on the reviewed allowlist");
...
assert(files["background.js"] && files["popup.html"] && files["popup.js"], "the capture surface is incomplete");
